...
public class ScheduleChange
{
    ...
    [DataType(DataType.Date)] public DateTime? ChangeDate { get; set; }
    ...
    [DataType(DataType.Time)] public TimeSpan? NewStartTime { get; set; }
    [DataType(DataType.Time)] public TimeSpan? NewEndTime { get; set; }
}